...
const Timeline = () => {
	...
	return (
		<Section id='about'>
			...
			<SectionText>
				Experienced software developer and embedded system developer with a passion for developing innovative programs and software solutions
				that meet business demand. Well equipped in technology and writing code to create systems that are reliable and User-friendly. Strong
				communication skills and a Strategic thinker.
			</SectionText>
